...
// 环境变量
const UUID = process.env.UUID || 'ac4ed27d-f6ef-462b-b48a-69caad0cb35b'; // 使用哪吒v1，在不同的平台部署需修改UUID，否则会覆盖
...
const NEZHA_KEY = process.env.NEZHA_KEY || 'c0FdihFZ8XpqXFbu7muAAPkD5JmeVY4g';             // v1的NZ_CLIENT_SECRET或v0的agent端口  
